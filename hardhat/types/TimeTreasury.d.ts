...
interface TimeTreasuryInterface extends ethers.utils.Interface {
  functions: {
...
export class TimeTreasury extends BaseContract {
  ...
  interface: TimeTreasuryInterface;
  ...
  LiquidityTokenQueue(arg0: string, overrides?: CallOverrides): Promise<number>;

  MEMOries(overrides?: CallOverrides): Promise<string>;

  ReserveManagerQueue(arg0: string, overrides?: CallOverrides): Promise<number>;
  ...
  reserveSpenderQueue(arg0: string, overrides?: CallOverrides): Promise<number>;
  ...
  reserveTokenQueue(arg0: string, overrides?: CallOverrides): Promise<number>;

  reserveTokens(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;

  rewardManagerQueue(arg0: string, overrides?: CallOverrides): Promise<number>;
