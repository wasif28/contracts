...
interface TimeBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class TimeBondingCalculator extends BaseContract {
  ...
  interface: TimeBondingCalculatorInterface;
