...
interface WMEMOInterface extends ethers.utils.Interface {
  functions: {
    "MEMO()": FunctionFragment;
    "MEMOTowMEMO(uint256)": FunctionFragment;
