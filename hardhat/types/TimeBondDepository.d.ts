...
interface TimeBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class TimeBondDepository extends BaseContract {
  ...
  interface: TimeBondDepositoryInterface;
